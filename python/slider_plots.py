...
def plot_waveform_sliders(G, params_list, width=900, height=550):
    

def plot_waveform_sliders_impl(G_list, params_list, suptitle = '', eddy_lines=[], eddy_range = [1e-3,120,1000], width=900, height=550):
    current_trace = 0
